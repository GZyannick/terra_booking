...
saturne = Planet.new(owner: alpha, name: "saturne", price: 3750, description: "planete non tellurique , belle vue sur la terre")
...
mars = Planet.create(owner: spock, name: "mars", price: 2130,description: "belle vue sur saturne")
...
venus = Planet.create(owner: spock, name: "venus", price: 5700,description: "pas de belle vue , venez comme vous etes")
...
neptune = Planet.create(owner: alpha, name: "neptune", price: 4000, description: "on est loin, loin, loin.........")
